...
% команда для создания линии подчеркивания под подпись
\newcommand{\signature}[2]{
	\begin{tabbing}
    \noindent#1\hspace{2cm} \= \raisebox{-0.7ex}{\makebox[2in]{\hrulefill}}\, #2\\
...
\newcommand{\code}[3]{
    ...
    \lstinputlisting[breaklines, caption=#2, label=#3]{#1}
}
