...
\usepackage{titlesec}                  % настройка заголовков (повтор)
...
% вставка pdg страниц (pdfpages несовместима с некоторыми другими пакетами)
%\usepackage{graphicx}
%\usepackage{geometry}
\newcommand{\inspdf}[2]{%
  \clearpage
  \thispagestyle{empty}% только для этой страницы
